...
bool PersistentStorage::validateConfig(const AppConfig& c){
 if(c.wetThreshold<0||c.wetThreshold>1023||c.dryThreshold<0||c.dryThreshold>1023) return false;
 ...
 return c.rainValueIncreasesWhenWet ? c.wetThreshold>c.dryThreshold : c.wetThreshold<c.dryThreshold;
}
...
bool PersistentStorage::loadConfig(AppConfig& c){
 ...
 AppConfig n; n.wetThreshold=d["wetThreshold"]|500; n.dryThreshold=d["dryThreshold"]|650; n.rainValueIncreasesWhenWet=d["rainValueIncreasesWhenWet"]|false;
...
bool PersistentStorage::saveConfig(const AppConfig& c){ JsonDocument d; d["wetThreshold"]=c.wetThreshold;d["dryThreshold"]=c.dryThreshold;d["rainValueIncreasesWhenWet"]=c.rainValueIncreasesWhenWet;d["rainConfirmationMs"]=c.rainConfirmationMs;d["dryConfirmationMs"]=c.dryConfirmationMs;d["fullTravelTimeMs"]=c.fullTravelTimeMs;d["motorPwmSpeed"]=c.motorPwmSpeed;d["motorDirectionReversed"]=c.motorDirectionReversed;d["motorTimeoutMarginMs"]=c.motorTimeoutMarginMs;return atomicWrite("/config.json",d); }
